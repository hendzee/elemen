    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <img src="<?=base_url();?>../assets/images/<?php echo $val['foto'];?>" class="user-image" alt="User Image">
            <span class="hidden-xs"><?php echo $val['nama_dpn']." ".$val['nama_blk'];?></span>
          </a>
          <ul class="dropdown-menu">
            <!-- User image -->
            <li class="user-header">
              ...
              <p>
                <?php echo $val['nama_dpn']." ".$val['nama_blk'];?>
                <small><?php echo $val['jabatan'];?></small>
              </p>
            </li>
            <!-- Menu Body -->
            <li class="user-body">
